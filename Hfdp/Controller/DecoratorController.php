...
class DecoratorController
{
    ...
    public function main()
    {
        ...
        \Hfdp\Utils::output($beverage->getDescription() . " $" . $beverage->cost());
        
        $beverage2 = new Decorator\DarkRoast();
        $beverage2 = new Decorator\Mocha($beverage2);
        $beverage2 = new Decorator\Mocha($beverage2);
        $beverage2 = new Decorator\Whip($beverage2);
        \Hfdp\Utils::output($beverage2->getDescription() . " $" . $beverage2->cost());
        ...
        \Hfdp\Utils::output($beverage3->getDescription() . " $" . $beverage3->cost());
    }
